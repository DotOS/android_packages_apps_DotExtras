...
public class dotsettings extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (suAvailable) {
            Snackbar.make(findViewById(R.id.drawer_layout), "Root Granted" , Snackbar.LENGTH_SHORT);
        } else {
            Snackbar.make(findViewById(R.id.drawer_layout), "Root Denied, please Check SU Binary" , Snackbar.LENGTH_SHORT);
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_sysreboot) {
            SuShell.run("pkill -f com.android.systemui");
            return true;
        }
